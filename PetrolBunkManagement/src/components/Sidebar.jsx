  ...
  return (
    <Link
      ...
      className={`
        ...
        hover:bg-gray-700 hover:text-white group relative overflow-hidden
...
const Sidebar = ({ updateSidebarState }) => {
  ...
  return (
    <aside 
      className={`
        fixed h-full bg-gray-800 shadow-lg z-20 
    ...
    >
      ...
      <div className="relative flex items-center justify-between p-4 overflow-hidden border-b border-gray-700">
        <div className={`
