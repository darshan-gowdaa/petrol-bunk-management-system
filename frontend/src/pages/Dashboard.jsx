...
const Dashboard = () => {
  ...
  // Function to get gradient background based on color
  const getGradientBackground = (color) => {
    switch (color) {
      case "blue":
        return "bg-gradient-to-br from-blue-500/20 to-blue-900/20 border-blue-500/50 hover:border-blue-400 hover:shadow-blue-500/20";
      case "green":
        return "bg-gradient-to-br from-green-500/20 to-green-900/20 border-green-500/50 hover:border-green-400 hover:shadow-green-500/20";
      case "purple":
        return "bg-gradient-to-br from-purple-500/20 to-purple-900/20 border-purple-500/50 hover:border-purple-400 hover:shadow-purple-500/20";
      case "orange":
        return "bg-gradient-to-br from-orange-500/20 to-orange-900/20 border-orange-500/50 hover:border-orange-400 hover:shadow-orange-500/20";
      case "teal":
        return "bg-gradient-to-br from-teal-500/20 to-teal-900/20 border-teal-500/50 hover:border-teal-400 hover:shadow-teal-500/20";
      case "red":
        return "bg-gradient-to-br from-red-500/20 to-red-900/20 border-red-500/50 hover:border-red-400 hover:shadow-red-500/20";
      default:
        return "bg-gradient-to-br from-gray-500/20 to-gray-900/20 border-gray-500/50 hover:border-gray-400 hover:shadow-gray-500/20";
    }
  };
